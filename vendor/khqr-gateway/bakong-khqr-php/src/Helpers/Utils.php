...
abstract class Utils
{
    ...
    public static function post_data_to_url(string $url, array $payload, ?string $bearerToken = null): array
    {
        ...
        $authorization = isset($bearerToken) ? (strpos($bearerToken, 'Bearer ') === 0 ? $bearerToken : 'Bearer ' . $bearerToken) : null;

        // Defined User Agent and Headers to bypass WAF
        $userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
        $referer = 'https://bakong.nbc.org.kh/';
        $origin = 'https://bakong.nbc.org.kh';
        ...
        if (!function_exists('curl_init')) {
            ...
            if ($response === false) {
                throw new KHQRException("Connection failed (file_get_contents fallback). URL: $url");
            }
