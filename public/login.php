...
<head>
    ...
    <title>Login - Mekong CyberUnit SaaS</title>
    <style>
...
<body>
    <form class="login-form" method="POST" action="login_process.php">
        ...
        <?php if (isset($_GET['error'])): ?>
            <div style="color: red; margin-bottom: 15px;"><?php echo htmlspecialchars($_GET['error']); ?></div>
        <?php endif; ?>

        <?php if (isset($_GET['success'])): ?>
            <div style="color: green; margin-bottom: 15px;"><?php echo htmlspecialchars($_GET['success']); ?></div>
        <?php endif; ?>
